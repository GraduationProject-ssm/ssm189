...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1T48XecE9G?p=183)


# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对学生课程学习信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款在线教育平台这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短学生课程学习信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约学生课程学习信息管理需要的人力和资金。所以在线教育平台是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对学生课程学习信息管理，采用在线教育平台可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用在线教育平台，其意义如下：

第一点：在线教育平台的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对在线教育平台设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对在线教育平台进行介绍时，将按照如下内容进行。

第一部分：介绍在线教育平台研究的背景意义，便于用户了解系统；

第二部分：介绍开发在线教育平台需要搭建的环境，包括技术和工具；

第三部分：介绍用户对在线教育平台的功能要求，以及对在线教育平台的性能要求等；
...
# 第2章 开发环境与技术
在线教育平台的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对在线教育平台用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，在线教育平台开发可行。
### 3.1.3 操作可行性
在线教育平台根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作在线教育平台。
...
在线教育平台经过分析，确定了其需要设置管理员的角色，其操作的功能通过用例图展示（见下图）。管理员管理在线学习信息与课程信息，管理教师和学生资料，管理留言和新闻。

![](/md/blog.005.png)

图3.5 管理员用例图

在线教育平台经过分析，确定了其需要设置教师的角色，其操作的功能通过用例图展示（见下图）。教师下载学生上交的作业文件，上传学生学习的视频，管理课程和留言。

![](/md/blog.006.png)

图3.6 教师用例图

在线教育平台经过分析，确定了其需要设置学生的角色，其操作的功能通过用例图展示（见下图）。学生通过视频的方式学习知识，可以收藏课程信息，能够提交课程留言和学习留言。
...
## 4.2 功能结构设计
在前面分析的管理员功能的基础上，进行接下来的设计工作，最终展示设计的管理员结构图（见下图）。管理员管理在线学习信息与课程信息，管理教师和学生资料，管理留言和新闻。

![](/md/blog.008.png)

图4.1 管理员功能结构图

在前面分析的教师功能的基础上，进行接下来的设计工作，最终展示设计的教师结构图（见下图）。教师下载学生上交的作业文件，上传学生学习的视频，管理课程和留言。

![](/md/blog.009.png)

图4.2 教师功能结构图

在前面分析的学生功能的基础上，进行接下来的设计工作，最终展示设计的学生结构图（见下图）。学生通过视频的方式学习知识，可以收藏课程信息，能够提交课程留言和学习留言。
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|kechng\_name|varchar(200)|是|NULL|课程名称 |
|kechng\_photo|varchar(200)|是|NULL|课程图片|
|kechng\_types|int(200)|是|NULL|类型 |
|shangke\_time|timestamp|是|NULL|上课时间|
|xiake\_time|timestamp|是|NULL|下课时间|
|kechng\_content|text|是|NULL|课程信息|
|create\_time|timestamp|是|NULL|创建时间  |
表4.3 留言板信息表
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|shangjiao\_name|varchar(200)|是|NULL|标题 |
|kechng\_types|int(200)|是|NULL|类型 |
|shangjiao\_file|varchar(200)|是|NULL|文件|
|yonghu\_id|int(100)|是|NULL|上交学生|
|shangjiao\_content|text|是|NULL|详情信息|
|create\_time|timestamp|是|NULL|创建时间|
表4.6 管理员信息表
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|zaixianxuexi\_name|varchar(200)|是|NULL|标题 |
|zaixianxuexi\_photo|varchar(200)|是|NULL|封面|
|kechng\_types|int(200)|是|NULL|类型 |
|zaixianxuexi\_video|varchar(200)|是|NULL|学习视频|
|jiaoshi\_id|int(100)|是|NULL|发布教师|
|zaixianxuexi\_content|text|是|NULL|详情信息|
|create\_time|timestamp|是|NULL|创建时间  |
...
图5.2 学生管理页面
### 5.1.3 新闻管理
管理员进入指定功能操作区之后可以管理新闻。其页面见下图。管理员在本页面可以增删改查新闻信息。已发布的新闻将会展示在前台。

![](/md/blog.018.png)

图5.3 新闻管理页面
### 5.1.4 留言板管理
管理员进入指定功能操作区之后可以管理留言板。其页面见下图。管理员查看学生留言，针对学生的留言内容进行回复。
...
## 5.2 教师功能实现
### 5.2.1 在线学习管理
教师进入指定功能操作区之后可以管理在线学习信息。其页面见下图。教师上传学习视频让学生在前台页面查看，教师管理本页面显示的学习视频信息，包括修改与查询。

![](/md/blog.020.png)

图5.5在线学习管理页面
### 5.2.2 课程管理
教师进入指定功能操作区之后可以管理课程。其页面见下图。教师查看课程的上课与下课时间，可以查询课程信息。

![](/md/blog.021.png)

图5.6 课程管理页面
### 5.2.3 上交作业管理
教师进入指定功能操作区之后可以管理上交作业。其页面见下图。教师下载学生上交的作业文件，查询学生上交的作业。
...
## 5.3 学生功能实现
### 5.3.1 在线学习
学生进入指定功能操作区之后可以在线学习知识。其页面见下图。学生可以通过观看视频获取知识，学生学习知识之后，可以在本页面提交学习留言。

![](/md/blog.023.png)

图5.8 在线学习页面
### 5.3.2 课程信息
学生进入指定功能操作区之后可以查看课程信息。其页面见下图。学生收藏课程，在本页面提交课程留言。

![](/md/blog.024.png)

图5.9 课程信息页面
### 5.3.3 留言板
学生进入指定功能操作区之后可以提交留言反馈信息。其页面见下图。学生提交的反馈信息主要让管理员查看，管理员的回复消息也会显示在本页面。
